...
if ($campus && !str_contains($campus->get('body')->value, 'node-featured-image')) {
  ...
  $hero = '<div class="node-featured-image"><img src="/sites/default/files/demo-images/photo-1498243691581-b145c3f54a5a.jpg" alt="Meridian AI campus coastal headland and redwood forest" loading="eager"></div>' . "\n\n";

  // Insert a library/reading-room photo after The Physical Campus section
  $reading_room = "\n\n" . '<div class="node-inline-image"><img src="/sites/default/files/demo-images/photo-1481627834876-b7833e8f5570.jpg" alt="The Crossing — Meridian AI library reading room overlooking Meridian Sea" loading="lazy"></div>' . "\n\n";
  ...
  $students = "\n\n" . '<div class="node-inline-image"><img src="/sites/default/files/demo-images/photo-1523050854058-8df90110c9f1.jpg" alt="Graduate students on campus during spring symposium" loading="lazy"></div>' . "\n\n";
...
if ($research && !str_contains($research->get('body')->value, 'node-featured-image')) {
  ...
  $hero = '<div class="node-featured-image"><img src="/sites/default/files/demo-images/photo-1507413245164-6160d8298b31.jpg" alt="Meridian AI research laboratory and scientific equipment" loading="eager"></div>' . "\n\n";

  // Insert a collaboration/whiteboard photo before Active Research Projects
  $collab = "\n\n" . '<div class="node-inline-image"><img src="/sites/default/files/demo-images/photo-1531746790731-6c087fecd65a.jpg" alt="Research team collaboration across Meridian AI schools" loading="lazy"></div>' . "\n\n";
