...
if ($about && !str_contains($about->get('body')->value, 'node-featured-image')) {
  ...
  $hero = '<div class="node-featured-image"><img src="/sites/default/files/demo-images/photo-1498243691581-b145c3f54a5a.jpg" alt="Meridian AI campus among coastal redwoods and mesa" loading="eager"></div>' . "\n\n";

  // Second image: students in seminar — insert before the Leadership section
  $seminar_img = "\n\n" . '<div class="node-inline-image"><img src="/sites/default/files/demo-images/photo-1522202176988-66273c2fd55f.jpg" alt="Graduate students in interdisciplinary seminar" loading="lazy"></div>' . "\n\n";
...
if ($admissions && !str_contains($admissions->get('body')->value, 'node-featured-image')) {
  ...
  $hero = '<div class="node-featured-image"><img src="/sites/default/files/demo-images/photo-1543269865-cbf427effbad.jpg" alt="Graduate students welcoming new cohort on campus" loading="eager"></div>' . "\n\n";
